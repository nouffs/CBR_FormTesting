...
//create a paragraph
            ...
            float[] columnWidths = {1.5f,1.5f,1,1};
            ...
            if (fields == null) {
                ...
                for (int i = 0; i < fields.size(); i++) {
                    insertCell(table, "Test-Cases for testing (" + fields.get(i).getName() + ") Field"+ ", [" +df.format((fields.get(i).getTestCases().get(1).getSimilarity()*100))+"%"+"]", Element.ALIGN_LEFT, 3, bfBold12, false);
                    insertCell(table, "Testing Result", Element.ALIGN_CENTER, 1, bfBold12, false);
                    ...
                    for (int j = 0; j < fields.get(i).getTestCases().size(); j++) {
                        ...
                        insertCell(table, fields.get(i).getTestCases().get(j).isCasePassed() ? "PASS" : "FAIL", Element.ALIGN_CENTER, 1, fields.get(i).getTestCases().get(j).isCasePassed() ? passFont : failFont, false);
